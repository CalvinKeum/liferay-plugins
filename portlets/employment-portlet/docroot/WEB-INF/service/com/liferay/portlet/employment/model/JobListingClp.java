 ...
 * @author Calvin Keum
 */
public class JobListingClp extends BaseModelImpl<JobListing>
	implements JobListing {
	public JobListingClp() {
	}
	...
	public void persist() throws SystemException {
		JobListingLocalServiceUtil.updateJobListing(this);
	}
	...
	public JobListing toEscapedModel() {
		if (isEscapedModel()) {
			...
			return (JobListing)Proxy.newProxyInstance(JobListing.class.getClassLoader(),
				new Class[] { JobListing.class },
	...
	@Override
	public Object clone() {
		JobListingClp clone = new JobListingClp();

		clone.setJobListingId(getJobListingId());
	...
	public boolean equals(Object obj) {
		...
		JobListingClp jobListing = null;

		try {
			jobListing = (JobListingClp)obj;
		}
